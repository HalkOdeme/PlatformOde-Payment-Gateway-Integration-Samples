...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="checkstatus.php">Ödeme Sorgulama</a>
                    </li>
    ...
    <div class="container">
        <h2 class="mt-5">Ödeme Sorgulama</h2>

        <!-- HTML Form for User Input -->
        <form method="post" class="mt-5">
            <label for="invoiceId" class="mt-2">Fatura ID:</label>
            <input type="text" id="invoiceId" name="invoice_id" value="" class="form-control mt-2" required><br><br>

            <button type="submit" name="process_payment" class="btn  mb-5">Ödemeyi Test Et</button>
        </form>

        <?php
        if (isset($_POST['process_payment'])) {
            // Temel değişkenleri tanımla
            $baseUrl = "https://testapp.platformode.com.tr/ccpayment/api/checkstatus";
