...
<head>
    ...
    <?php include '2dpay/style/2dstyle.php' ?>
</head>

<body>
    <?php include '2dpay/nav/2dnav.php' ?>
    ...
    if (isset($_POST['process_payment'])) {
        ...
        $baseUrl = "https://testapp.platformode.com.tr/ccpayment/api/complete";  // URL-encoded endpoint
    ...
    {
        $baseUrl = "https://testapp.platformode.com.tr/ccpayment/api/token";  // URL-encoded endpoint
